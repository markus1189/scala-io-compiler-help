...
\begin{frame}
  ...
  \item we can use them to add some information to values 
  \end{itemize}
\end{frame}
...
\begin{frame}
  ...
  \item killer feature: perform validation for literals as input at compile time
  \end{itemize}
\end{frame}
...
\begin{frame}
  \frametitle{Case Study}
  \inputminted[fontsize=\small,firstline=9, lastline=23]{scala}{../src/main/scala/de/codecentric/three/VendingMachine.scala}
\end{frame}

\section{Restrict Valid Operations}

\begin{frame}
  \frametitle{Restrict Valid Operations}
  \begin{center}
...
\begin{frame}[fragile]
  ...
  \begin{center}
    \inputminted[fontsize=\small, firstline=11,
    lastline=14]{scala}{../src/main/scala/de/codecentric/four/VendingMachine.scala}
  \end{center}
  \begin{center}
...
\begin{frame}[fragile]
  ...
  \inputminted[firstline=16, lastline=34, fontsize=\small]{scala}{../src/main/scala/de/codecentric/four/VendingMachine.scala}
\end{frame}

\begin{frame}[fragile]
  \frametitle{State Machine: Typeclass}
  \inputminted[firstline=39, lastline=49, fontsize=\small]{scala}{../src/main/scala/de/codecentric/four/VendingMachine.scala}
\end{frame}

\begin{frame}[fragile]
  \frametitle{State Machine: Implicit Evidence}
  \inputminted[firstline=51, lastline=62, fontsize=\small]{scala}{../src/main/scala/de/codecentric/four/VendingMachine.scala}
\end{frame}
